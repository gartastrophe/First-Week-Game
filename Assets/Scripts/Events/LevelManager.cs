...
public class LevelManager : MonoBehaviour
{
    ...
    [HideInInspector] public bool gameOverTriggered = false;
    [HideInInspector] public bool gameWonTriggered = false;
    ...
    private void TriggerBlackOut()
    {
        ...
        Instantiate(blackOutPrefab, transform.position, transform.rotation);
    }
